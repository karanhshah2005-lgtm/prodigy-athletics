    ...
    <div class="pdp__grid">
      ...
      <div class="pdp__buy">
        ...
        <div class="pdp__sec">
          ...
          <p class="t-body-s">The two photographs are placeholders standing in for Prodigy&rsquo;s own product photography. The renders are drawn from the pattern file and show the cut, not the fabric.</p>
        </div>
      </div>
    </div>
